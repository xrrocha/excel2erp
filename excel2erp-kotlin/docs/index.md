...
# De la Aritmética al Álgebra en el Desarrollo

<style>
/* Mobile-first: "educational doomscrolling" on phones */
@media (max-width: 768px) {
  /* Target ALL possible scroll containers */
  html, body, .markdown-body, .container, main, article {
  ...
  /* Visual separator between "slides" */
  section + section {
    border-top: 3px solid #e0e0e0;
  }
}
/* Desktop: normal continuous reading experience */
