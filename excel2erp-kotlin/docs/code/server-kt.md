...
<p class="snapshot">Código al momento de publicación. <a href="https://github.com/xrrocha/excel2erp/blob/main/excel2erp-kotlin/src/main/kotlin/Server.kt">Ver versión actual en GitHub</a>.</p>
...
<div class="nav">
  <a class="prev" href="../07-htmx.html">← Volver a "Tlön, Uqbar, HTMX"</a>
</div>
