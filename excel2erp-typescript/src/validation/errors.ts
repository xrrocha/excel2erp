 ...
 */
export class Excel2ErpError extends Error {
  constructor(
 ...
 */
export function createFileFormatError(details: string, suggestions?: string[]): Excel2ErpError {
  return new Excel2ErpError(
 ...
 */
export function createConfigError(details: string, suggestions?: string[]): Excel2ErpError {
  return new Excel2ErpError(
 ...
 * Extraction errors.
 */
export function createExtractionError(details: string, suggestions?: string[]): Excel2ErpError {
  return new Excel2ErpError(
 ...
 * Validation errors.
 */
export function createValidationError(details: string, suggestions?: string[]): Excel2ErpError {
  return new Excel2ErpError(
 ...
 */
export function createNetworkError(details: string, suggestions?: string[]): Excel2ErpError {
  return new Excel2ErpError(
 ...
 */
export function wrapError(error: unknown, context: string): Excel2ErpError {
  if (error instanceof Excel2ErpError) {
    return error;
  }
