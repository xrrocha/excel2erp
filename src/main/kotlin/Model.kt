...
// TODO Allow for optional properties in FileSpec
data class FileSpec(
    val filename: String,
    val prolog: String = "",
    val epilog: String = "",
...
// TODO Guarantee regexp evaluation order in source property
data class SourceProperty(
    ...
    // TODO Limit conversion to first match?
...
data class Source(
    ...
    fun resolveDetail(
        detailSpec: FileSpec
    ): (Workbook) -> List<Map<String, String?>> {
        val detailMap =
        ...
        return { wb: Workbook ->
            detail.extract(wb.getSheetAt(sheetIndex)).map { record ->
...
data class Detail(
    ...
    fun extract(sheet: Sheet): List<Map<String, String?>> =
